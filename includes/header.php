...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Kanit:wght@400;600;700&family=Sarabun:wght@300;400;700&display=swap" rel="stylesheet">
    
    <style>
        :root { --primary: #004d40; --gold: #ffc107; --dark: #1a1a1a; }
        body { font-family: 'Sarabun', sans-serif; background: #fdfdfd; color: #2c3e50; }
        h1, h2, h3, .navbar-brand { font-family: 'Kanit', sans-serif; }
        ...
        .nav-link { color: #ffffff !important; margin: 0 10px; transition: 0.3s; }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item"><a class="nav-link" href="travel.php">ที่เที่ยว</a></li>
